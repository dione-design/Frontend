...
const FullwidthRightSidebar = ({ products }) => {
  ...
  return (
    <LayoutTwo>
      {/* breadcrumb */}
      <BreadcrumbOne
        pageTitle="Shop Full Width Right Sidebar"
      ...
      >
        <ul className="breadcrumb__list">
          ...
          <li>Shop Full Width Right Sidebar</li>
        </ul>
      </BreadcrumbOne>
...
export default connect(mapStateToProps)(FullwidthRightSidebar);
